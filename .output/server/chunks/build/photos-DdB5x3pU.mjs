                          ...
                          if (_push4) {
                            _push4(ssrRenderComponent(VCard, { elevation: "16" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="relative" data-v-58b24d1f${_scopeId4}><img${ssrRenderAttr("src", photo.thumbnail_path)} alt="photo" class="w-full h-auto photo-img"${ssrRenderAttr("data-id", photo.id)} data-v-58b24d1f${_scopeId4}>`);
                                  if (imageSizes.value[photo.id]) {
                                    _push5(`<!--[-->`);
                                    ssrRenderList(photo.bounding_boxes || [], (box, index) => {
                                      _push5(`<div class="bounding-box" style="${ssrRenderStyle(getBoxStyle(box, imageSizes.value[photo.id]))}" data-v-58b24d1f${_scopeId4}></div>`);
                                    });
                                    _push5(`<!--]-->`);
                                  } else {
                                    _push5(`<!---->`);
                                  ...
                                  _push5(ssrRenderComponent(VCardSubtitle, null, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<small data-v-58b24d1f${_scopeId5}><code data-v-58b24d1f${_scopeId5}>Uploaded at: ${ssrInterpolate(formatDate(photo.uploaded_at))}</code></small>`);
                                      } else {
                                        return [
                                  ...
                                  _push5(`<div data-v-58b24d1f${_scopeId4}>`);
                                  ...
                                  _push5(ssrRenderComponent(VExpandTransition, null, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div style="${ssrRenderStyle(show.value ? null : { display: "none" })}" data-v-58b24d1f${_scopeId5}>`);
                                        _push6(ssrRenderComponent(VDivider, null, null, _parent6, _scopeId5));
                                        _push6(ssrRenderComponent(VCardText, null, {
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              _push7(`<p class="d-flex align-center" data-v-58b24d1f${_scopeId6}><i class="bx bxs-wallet-alt mr-2" data-v-58b24d1f${_scopeId6}></i> Rp ${ssrInterpolate(photo.unit_price.toLocaleString())}</p><div class="d-flex align-center text-medium-emphasis" data-v-58b24d1f${_scopeId6}><i class="bx bxs-map mr-2" data-v-58b24d1f${_scopeId6}></i> ${ssrInterpolate(photo.unit_name)}</div>`);
                                            } else {
                                              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/units/photos.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const photos = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-58b24d1f"]]);
