import * as cpexcel from '/Applications/MAMP/htdocs/nuxtjs/dufansnap/node_modules/xlsx/dist/cpexcel.js';
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(cpexcel);

const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(fs);

const require$$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(require$$0$2);
...
(function (module, exports) {
	...
	*/
	...
	var _fs;
	if(typeof commonjsRequire !== 'undefined') try { _fs = require('fs'); } catch(e) {}
...
function useReports() {
  const getAllUnitReports = async (startDate, endDate) => {
    const data = await authFetch(`/statistics/reports/transactions-all-unit`, {});
    return data;
  };
  const getPerUnitReports = async (unit_id, startDate, endDate) => {
    const data = await authFetch(`/statistics/reports/transactions-by-unit`, {});
    console.log(data);
    return data;
  };
  const getPerOutletReports = async (outlet_id, startDate, endDate) => {
    const data = await authFetch(`/statistics/reports/transactions-by-outlet-id`, {});
    console.log(data);
    return data;
  };
  const getDasboardStatistcs = async () => {
    const data = await authFetch(`/statistics/`, {});
    return data;
  };
  const getTransactionsReport = async (startDate, endDate) => {
    const data = await authFetch(`/statistics/reports/transactions`, {});
    return data;
  };
  const getFotoTerjualReport = async (startDate, endDate) => {
...
export { useReports as u, xlsxExports as x };
