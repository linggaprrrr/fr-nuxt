...
import UserLayoutWithVerticalNav from './UserLayoutWithVerticalNav-Dye0p8sz.mjs';
...
import './UserNavItems-XAGryQIR.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(UserLayoutWithVerticalNav, _attrs, {
