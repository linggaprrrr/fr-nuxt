...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function fetchEditOutletsByUnit(unitId) {
      var _a;
      const outletRes = await getOutletsByUnit(unitId);
      if ((outletRes == null ? void 0 : outletRes.status_code) === 200 && Array.isArray(outletRes.outlets)) {
        ...
        if (!editOutletList.value.some((outlet) => outlet.id === formEditPhotoPricing.value.outlet_id)) {
          formEditPhotoPricing.value.outlet_id = ((_a = outletRes.outlets[0]) == null ? void 0 : _a.id) || "";
        }
      } else {
      ...
      async (newUnitId) => {
        ...
        if (newUnitId) {
          ...
          if ((outletRes == null ? void 0 : outletRes.status_code) === 200 && Array.isArray(outletRes.outlets)) {
            ...
            formPhotoPricing.value.outlet_id = ((_a = outletRes.outlets[0]) == null ? void 0 : _a.id) || "";
          } else {
            outletList.value = [];
                                  ...
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(VCol, { cols: "9" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VTextField, {
                                            modelValue: unref(formPhotoType).kode_folder,
                                            "onUpdate:modelValue": ($event) => unref(formPhotoType).kode_folder = $event,
                                            "persistent-hint": ""
                                          }, null, _parent7, _scopeId6));
                                        } else {
                                          return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VTable, { density: "compact" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<thead${_scopeId2}><tr${_scopeId2}><th${_scopeId2}>#</th><th${_scopeId2}>Nama</th><th${_scopeId2}>Deskripsi</th><th${_scopeId2}>Kode Folder</th><th${_scopeId2}></th></tr></thead><tbody${_scopeId2}>`);
                  if (!unref(isLoading) && unref(photoTypes).length === 0) {
                    _push3(`<tr${_scopeId2}><td colspan="5" class="text-center"${_scopeId2}>Tidak ada data</td></tr>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(photoTypes), (photoType, index) => {
                    _push3(`<tr${_scopeId2}><td${_scopeId2}>${ssrInterpolate(index + 1 + (unref(pagePhotoTypes) - 1) * limit)}</td><td${_scopeId2}>${ssrInterpolate(photoType.name)}</td><td${_scopeId2}>${ssrInterpolate(photoType.description)}</td><td${_scopeId2}><span class="font-weight-bold text-error"${_scopeId2}>${ssrInterpolate(photoType.kode_folder)}</span></td><td${_scopeId2}>`);
                    ...
                    createVNode("tbody", null, [
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(photoTypes), (photoType, index) => {
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", null, [
                            createVNode("span", { class: "font-weight-bold text-error" }, toDisplayString(photoType.kode_folder), 1)
                          ]),
                          createVNode("td", null, [
                            createVNode(VBtn, {
                              icon: "",
                                  ...
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(VCol, { cols: "9" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VTextField, {
                                            modelValue: unref(formEditPhotoType).kode_folder,
                                            "onUpdate:modelValue": ($event) => unref(formEditPhotoType).kode_folder = $event,
                                            "persistent-hint": ""
                                          }, null, _parent7, _scopeId6));
                                        } else {
                                          return [
                                  ...
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(VCol, { cols: "10" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VSelect, {
                                            modelValue: unref(formPhotoPricing).outlet_id,
                                            "onUpdate:modelValue": ($event) => unref(formPhotoPricing).outlet_id = $event,
                                            density: "comfortable",
                                            items: unref(outletList),
                                            "item-value": "id",
                                            "item-title": "name",
                                            class: "mb-4",
                                            variant: "outlined"
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VTable, { density: "compact" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<thead${_scopeId2}><tr${_scopeId2}><th${_scopeId2}>#</th><th${_scopeId2}>Outlet</th><th${_scopeId2}>Unit</th><th${_scopeId2}>Tipe Foto</th><th${_scopeId2}>Harga</th><th${_scopeId2}></th></tr></thead><tbody${_scopeId2}>`);
                  ...
                  ssrRenderList(unref(photoPrices), (photoPrice, index) => {
                    _push3(`<tr${_scopeId2}><td${_scopeId2}>${ssrInterpolate(index + 1 + (unref(pagePhotoPrices) - 1) * limit)}</td><td${_scopeId2}>${ssrInterpolate(photoPrice.outlet_name)}</td><td${_scopeId2}>${ssrInterpolate(photoPrice.unit_name)}</td><td${_scopeId2}>${ssrInterpolate(photoPrice.photo_type_name)}</td><td${_scopeId2}>Rp ${ssrInterpolate(photoPrice.price.toLocaleString())}</td><td${_scopeId2}>`);
                    _push3(ssrRenderComponent(VBtn, {
                      icon: "",
                      variant: "text",
                      size: "small",
                    ...
                    createVNode("tbody", null, [
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(photoPrices), (photoPrice, index) => {
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", null, toDisplayString(photoPrice.outlet_name), 1),
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        ...
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VSelect, {
                                            ...
                                            "item-value": "id",
                                            "item-title": "name",
                                            hint: (_a = unref(selectedEditUnit)) == null ? void 0 : _a.location,
                                            "persistent-hint": "",
                                            density: "comfortable",
                                            class: "mb-4",
                                            variant: "outlined"
                                          ...
                                          return [
                                            createVNode(VSelect, {
                                              ...
                                              "item-value": "id",
                                              "item-title": "name",
                                              hint: (_b = unref(selectedEditUnit)) == null ? void 0 : _b.location,
                                              "persistent-hint": "",
                                              density: "comfortable",
                                              class: "mb-4",
                                              variant: "outlined"
                                  ...
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(VCol, { cols: "10" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VSelect, {
                                            modelValue: unref(formEditPhotoPricing).outlet_id,
                                            "onUpdate:modelValue": ($event) => unref(formEditPhotoPricing).outlet_id = $event,
                                            items: unref(editOutletList),
                                            "item-value": "id",
                                            "item-title": "name",
                                            density: "comfortable",
                                            class: "mb-4",
                        ...
                        _push4(ssrRenderComponent(VCardActions, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(VBtn, {
                                color: "primary",
                                onClick: handleEditPhotoPricing
                              }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Simpan`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/photo-pricing.vue");
