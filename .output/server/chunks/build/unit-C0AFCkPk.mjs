...
import UnitLayoutWithVerticalNav from './UnitLayoutWithVerticalNav-CStuByOd.mjs';
...
import './UnitNavItems-p5bNM1Qr.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(UnitLayoutWithVerticalNav, _attrs, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/unit.vue");
