...
import { g as getApiErrorMessage } from './authFetch-5wQjlWwJ.mjs';
  ...
  setup(__props) {
    ...
    function openEditModal(outlet) {
      ...
      form.value = {
        ...
        unit_id: ((_a = outlet.unit) == null ? void 0 : _a.id) || ""
      };
      showEdit.value = true;
    }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VTable, { density: "compact" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<thead${_scopeId2}><tr${_scopeId2}><th${_scopeId2}>#</th><th${_scopeId2}>Name</th><th${_scopeId2}>Telp</th><th${_scopeId2}>Unit</th><th${_scopeId2}>Kode Folder</th><th${_scopeId2}>Dibuat</th><th${_scopeId2}></th></tr></thead><tbody${_scopeId2}>`);
                  ...
                  ssrRenderList(outlets.value, (outlet, index) => {
                    _push3(`<tr${_scopeId2}><td${_scopeId2}>${ssrInterpolate(index + 1 + (page.value - 1) * limit)}</td><td${_scopeId2}>${ssrInterpolate(outlet.name)}</td><td${_scopeId2}>${ssrInterpolate(outlet.phone)}</td><td${_scopeId2}>${ssrInterpolate(outlet.unit.name)}</td><td${_scopeId2}><span class="font-weight-bold text-error"${_scopeId2}>${ssrInterpolate(outlet.kode_folder)}</span></td><td${_scopeId2}>${ssrInterpolate(new Date(outlet.created_at).toISOString().slice(0, 10))}</td><td${_scopeId2}>`);
                    ...
                    createVNode("tbody", null, [
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(outlets.value, (outlet, index) => {
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", null, [
                            createVNode("span", { class: "font-weight-bold text-error" }, toDisplayString(outlet.kode_folder), 1)
                          ]),
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VSelect, {
                                      modelValue: form.value.unit_id,
                                      "onUpdate:modelValue": ($event) => form.value.unit_id = $event,
                                      density: "comfortable",
                                      items: units.value,
                                      "item-value": "id",
                                      "item-title": "name",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/outlets.vue");
